    ...
    <div class="container mx-auto px-6 py-16">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
                ...
                <h1 class="text-4xl md:text-5xl font-display font-bold text-stone-900 mt-2 mb-4">{{ $product->name }}</h1>
                ...
                <a href="https://api.whatsapp.com/send?phone=6281234567890&text=Halo,%20saya%20tertarik%20dengan%20produk%20'{{ urlencode($product->name) }}'" target="_blank" class="mt-8 inline-block bg-green-600 text-white uppercase tracking-widest px-8 py-3 rounded-md font-semibold text-sm hover:bg-green-700 transition duration-300">
                    Pesan via WhatsApp
                </a>
